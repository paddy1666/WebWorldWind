...
define([
    ...
    function (AbsentResourceList,
        ...
        var WcsElevationModel = function (coverageSector, levelZeroDelta, numLevels, retrievalImageFormat, cachePath,
            ...
            this.id = ++WcsElevationModel.idPool;
        ...
        WcsElevationModel.idPool = 0; // Used to assign unique IDs to elevation models for use in their state key.
         ...
         */
        WcsElevationModel.prototype.minAndMaxElevationsForSector = function (sector) {
            if (!sector) {
                throw new ArgumentError(
         ...
         */
        WcsElevationModel.prototype.elevationAtLocation = function (latitude, longitude) {
         ...
         */
        WcsElevationModel.prototype.elevationsForGrid = function (sector, numLat, numLon, targetResolution, result) {
            if (!sector) {
                throw new ArgumentError(
        ...
        WcsElevationModel.prototype.pointElevationForLocation = function (latitude, longitude) {
        ...
        // Intentionally not documented.
        WcsElevationModel.prototype.pointElevationsForGrid = function (sector, numLat, numLon, level, result) {
            var maxResolution = 0,
                resolution;
        ...
        WcsElevationModel.prototype.areaElevationsForGrid = function (sector, numLat, numLon, level, result) {
        ...
        WcsElevationModel.prototype.areaElevationForCoord = function (s, t, levelNumber, result, resultIndex) {
        ...
        WcsElevationModel.prototype.lookupPixels = function (x0, x1, y0, y1, level, retrieveTiles, result) {
        ...
        WcsElevationModel.prototype.lookupImage = function (levelNumber, row, column, retrieveTiles) {
        ...
        // Intentionally not documented.
        WcsElevationModel.prototype.createTile = function (sector, level, row, column) {
        ...
        // Intentionally not documented.
        WcsElevationModel.prototype.assembleTiles = function (level, sector, retrieveTiles) {
            this.currentTiles = [];
        ...
        // Intentionally not documented.
        WcsElevationModel.prototype.addTileOrAncestor = function (level, row, column, retrieveTiles) {
        ...
        // Intentionally not documented.
        WcsElevationModel.prototype.addAncestor = function (level, row, column, retrieveTiles) {
            var tile = null,
                r = Math.floor(row / 2),
        ...
        WcsElevationModel.prototype.addToCurrentTiles = function (tile) {
            this.currentTiles.push(tile);
        };

        WcsElevationModel.prototype.tileForLevel = function (levelNumber, row, column) {
        ...
        WcsElevationModel.prototype.isTileImageInMemory = function (tile) {
            return this.imageCache.containsKey(tile.imagePath);
        };

        WcsElevationModel.prototype.resourceUrlForTile = function (tile) {
        ...
        // Intentionally not documented.
        WcsElevationModel.prototype.removeFromCurrentRetrievals = function (imagePath) {
        ...
        // Intentionally not documented.
        WcsElevationModel.prototype.loadElevationImage = function (tile, elevationData) {
            var elevationImage = new ElevationImage(tile.imagePath, tile.sector, tile.tileWidth, tile.tileHeight);

            elevationImage.imageData = elevationData;
